/**
 * Frontend Page Catalog configuration for KDP Front Matter & Back Matter Pages
 */

export const FRONT_MATTER_CATALOG = [
  {
    pageType: 'title_page',
    title: 'Title Page',
    section: 'FRONT',
  ...
  },
  {
    ...
    section: 'FRONT',
    defaultOrder: 2,
    description: 'Contains copyright year, rights statement, ISBN, and drafting disclosure clause.',
    requiresInput: true,
    recommendedFor: ['fiction', 'non-fiction', 'memoir', 'educational', 'guide', 'workbook', 'cookbook', 'children', 'journal', 'low-content']
  },
  {
...
export const BACK_MATTER_CATALOG = [
  {
    pageType: 'appendix',
    title: 'Appendix',
    section: 'BACK',
...
export const FULL_MATTER_CATALOG = [...FRONT_MATTER_CATALOG, ...BACK_MATTER_CATALOG];

export function getRecommendedDefaults(bookType = 'non-fiction') {
